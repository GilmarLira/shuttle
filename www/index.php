...
<head>
	...
	<link rel="apple-touch-icon" sizes="114x114" href="img/apple-touch-icon_2x.png" />
	...
	<div id="container">
		<div id="lister">
			...
			<header>
				...
				<!-- List results -->
				<div class="filters">
					<h4 class="line">line</h4>
					<h4 class="time">departs</h4>
					<h4 class="time">arrives</h4>
				...
				<?php
					if ($origin != NULL && $destination != NULL) {
						...
						while ($row = mysql_fetch_assoc($resultMaster)) {
							...
							echo ('">
										<h2 id="line'.$masterResults.'" class="line">'.$row['Route'].'</h2>
										<h3 class="time">'.$row['Departure'].' – '.$row['Arrival'].'</h3>
							...
							if($hourFlag==1){
								echo ('
										<canvas id="can'.$masterResults.'" class="canvas-circle"></canvas>
										');
							}
